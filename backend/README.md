...
## Project Structure
    ...
    ├── nda_and_covid_form_35947  # Django project configurations
...
1. Clone this repo and `cd nda_and_covid_form_35947`
...
2. Clone this repo and `cd nda_and_covid_form_35947`
